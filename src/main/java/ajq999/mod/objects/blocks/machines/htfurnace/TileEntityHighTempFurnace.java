...
public class TileEntityHighTempFurnace extends TileEntity implements IInventory, ITickable
{
	...
	{
		return this.hasCustomName() ? this.customName : "container.high_temp_furnace";
	}
	...
	public void update() 
	{
		...
		if(!this.world.isRemote) 
		{
			...
			{
				flag1 = true;
				BlockHighTempFurnace.setState(this.isBurning(), this.world, this.pos);
			}
		} 
	...
	private boolean canSmelt() 
	{
		...
		{
			ItemStack result = HighTempFurnaceRecipes.getInstance().getHighTempResult((ItemStack)this.inventory.get(0), (ItemStack)this.inventory.get(1));	
	...
	public void smeltItem() 
	{
		if(this.canSmelt()) 
		{
			...
			ItemStack result = HighTempFurnaceRecipes.getInstance().getHighTempResult(input1, input2);
			ItemStack output = (ItemStack)this.inventory.get(3);
